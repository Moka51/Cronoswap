...
import { useCroc, useSousChef, useCrocVaultContract } from 'hooks/useContract'
  ...
  const handleApprove = async () => {
    ...
    if (receipt.status) {
      toastSuccess(
        t('Contract Enabled'),
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('You can now stake in the %symbol% vault!', { symbol: 'MMF' })}
        </ToastDescriptionWithTx>,
      )
      setLastUpdated()
      setRequestedApproval(false)
