...
import { Box, Button, Flex, InjectedModalProps, LinkExternal, Message, Skeleton, Text } from '@crocswap/uikit'
  ...
  return (
    <>
      ...
      <Flex alignItems="left" justifyContent="end" mb="24px">
        <LinkExternal href={getBscScanLink(account, 'address')}>{t('View on Cronos explorer')}</LinkExternal>
      </Flex>
