...
const ifos: Ifo[] = [
  {
    ...
    description: 'Cronos FC is the first ever R2E (Risk-To-Earn) platform on the entire Cronos Chain. It combines both non-fungible tokens (NFTs) and elements of Decentralised Finance (DeFi) to bring yield farming to players. Project took inspiration from renowned Wolf Game on Ethereum and Police & Thief on Avax.',
    currency: tokens.mmf,
    token: tokens.goal,
    startTimestamp: 1647763200,
    endTimestamp: 1647784800,
    campaignId: '10',
    articleUrl: 'https://medium.com/@MMFinance/9th-launchpad-cronos-fc-a32d5880cbce',
    tokenOfferingPrice: '$0.03',
    projectSite: 'https://cronosfc.club/',
    version: 1,
    loadIfoData: true,
  },
  {
