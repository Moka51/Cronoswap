...
export interface NFT extends NFTConfig {
  userData?: {
    balanceOf: number
    tokenIds: number[]
    inventory: any[]
...
export interface CrocVault {
  totalShares?: string
  pricePerFullShare?: string
  totalCrocInVault?: string
  estimatedCrocBountyReward?: string
  totalPendingCrocHarvest?: string
  fees?: VaultFees
  userData?: VaultUser
}
...
export interface LotteryRound extends LotteryRoundGenerics {
  ...
  priceTicketInCroc: BigNumber
  discountDivisor: BigNumber
  amountCollectedInCroc: BigNumber
...
export interface LotteryResponse extends LotteryRoundGenerics {
  priceTicketInCroc: SerializedBigNumber
  discountDivisor: SerializedBigNumber
  amountCollectedInCroc: SerializedBigNumber
