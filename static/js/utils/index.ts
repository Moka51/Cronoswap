...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@madmeerkat/sdk'
...
export function getBscScanLinkForNft(
  ...
  return `${BASE_EXPLORER_URLS[chainId]}/token/${collectionAddress}?a=${tokenId}`
}
