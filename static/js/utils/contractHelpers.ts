...
import {
  ...
  getMulticallAddress,
  getBunnySpecialCrocVaultAddress,
...
import bunnySpecialCrocVaultAbi from 'config/abi/bunnySpecialCakeVault.json'
...
import meerkatReferral from 'config/abi/meerkatReferral.json'
import mmbToken from 'config/abi/mmbToken.json'
...
export const getCrocContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(cakeAbi, tokens.mmf.address, signer)
}
...
export const getCrocVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(cakeVaultAbi, getCrocVaultAddress(), signer)
}
...
export const getBunnySpecialCrocVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(bunnySpecialCrocVaultAbi, getBunnySpecialCrocVaultAddress(), signer)
}
...
export const getCrocReferralContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(meerkatReferral, getCrocReferralAddress(), signer)
}

export const getNFTSeries1Contract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(mmbToken, getNFTSeries1Address(), signer)
}
