...
import {
  ...
  getErc721Contract,
  getCrocVaultContract,
  getPredictionsContract,
  getChainlinkOracleContract,
  getSouschefV2Contract,
  getLotteryV2Contract,
  getBunnySpecialCrocVaultContract,
  ...
  getCrocReferralContract,
  getNFTSeries1Contract,
} from 'utils/contractHelpers'
import { getMulticallAddress } from 'utils/addressHelpers'

// Imports below migrated from Exchange useContract.ts
import { Contract } from '@ethersproject/contracts'
import { ChainId, WETH } from '@madmeerkat/sdk'
...
export const useCroc = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getCrocContract(library.getSigner()), [library])
}
...
export const useCrocVaultContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getCrocVaultContract(library.getSigner()), [library])
}
...
export const useSpecialBunnyCrocVaultContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getBunnySpecialCrocVaultContract(library.getSigner()), [library])
}
...
export const useNFTSeries1Contract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getNFTSeries1Contract(library.getSigner()), [library])
}
...
export const useCrocReferralContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getCrocReferralContract(library.getSigner()), [library])
}
